	...
	<div class="row">
		...
		<div class="col-2 border p-0" id="sub-category">
			...
			<div class="list-group d-none" id="sub-category-11">
				...
				<a href="itsubmainlist.jsp?categoryGroupNo=1102" class="list-group-item show-category">IT 비즈니스</a>
				<a href="itsubmainlist.jsp?categoryGroupNo=1103" class="list-group-item show-category">개발/프로그래밍</a>
				<a href="itsubmainlist.jsp?categoryGroupNo=1104" class="list-group-item show-category">컴퓨터/앱 활용</a>
				<a href="itsubmainlist.jsp?categoryGroupNo=1105" class="list-group-item show-category">IT 자격증</a>
				<a href="itsubmainlist.jsp?categoryGroupNo=1105" class="list-group-item show-category">IT 해외원서</a>
			</div>
