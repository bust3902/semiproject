...
<!-- 이름 / 아이디 / 이메일 / 보유캐시 를 포함한 내 정보(캐시) 페이지   -->
							...
							<tbody>
								<tr class="border-bottom ">
									...
									<td class="text-start align-middle p-3 px-4 ">
										...
										<div class="mb-4" style="font-size:16px;">이메일 : <%=user.getEmail() %></div>
										<div class="mb-2 text-danger" style="font-size:16px; font-weight:bold">보유캐시 : <%=user.getCash() %> 원
