  ...
  <nav class="bg-info border-bottom fixed-top">
    <div class="container d-flex flex-wrap">
      <ul class="nav me-auto">
        <li class="nav-item"><a href="/semiproject/home.jsp" class="nav-link link-dark px-0"><Strong class="text-white" style="font-size:20px">HTA</strong></a></li>
        <li class="nav-item"><a href="#" class="nav-link link-dark px-1"><Strong class="text-white" style="font-size:17px">|</Strong></a></li>
        <li class="nav-item"><a href="/semiproject/userCenter/userCenterBoard.jsp" class="nav-link link-dark px-0"><Strong class="text-white" style="font-size:20px">고객센터</Strong></a></li>
      </ul>
