...
public class CashPagination {
	...
	public CashPagination(int totalRows, int currentPage) {
		this(5, totalRows, currentPage);
	}
			// 몇 개씩 보여줄지 내가 조절하는 생성자 
	public CashPagination(int rows, int totalRows, int currentPage) {
		this.rows = rows;	
		this.pages = 10; // 한 페이지에 출력할 행의 갯수 
